...
-   Checking if the z-score of the outcome and predictor have a linear relationship ::: {.fragment}
...
-   Breaking the assumption that the z-score of the outcome and the predictor/s have a linear relationship ::: {.fragment}
...
Similar to our probit regression, we used `optim` to maximize our log likelihood function
